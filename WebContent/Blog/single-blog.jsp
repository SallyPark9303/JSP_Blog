	...
	$.ajax({
	    ...
	    success:function(d){
	    		...
	    		for(var i=0; i<a.length; i++){
	    			htmlStr+="<tr>";
	    			htmlStr+="<td>"+a[i].msg+"</td>";
	    			htmlStr+="<td>"+a[i].name+"</td>";
	    			htmlStr+="<td>"+a[i].regdate+"</td>";
	    			htmlStr+="</tr>";
	    		}
	    		htmlStr+="</table>";
									...
									<img class="img-fluid" src="../upload/${item.filename }" alt="" width="500px" height="300px">
						                  ...
						                  <h2>${item.title }</h2>
													...
													<ul class="blog-info-link mt-3 mb-4">
														...
														<li><i class="fa fa-comments"></i><span onclick="commentStr('commentArea${status.index}',${item.num},${status.index})">Comments</span></li> <!-- 댓글기능 -->
